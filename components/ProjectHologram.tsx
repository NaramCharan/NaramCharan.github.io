      ...
      {project && (
        ...
        >
          ...
          <motion.div
            ...
            className="scanlines relative z-10 flex max-h-[86vh] w-full max-w-2xl flex-col overflow-hidden rounded-xl border border-cyan/40 bg-surface/85 shadow-[0_0_60px_-10px_rgba(34,211,238,0.5)] outline-none backdrop-blur-md"
          >
            {/* Corner brackets */}
            {[
              "left-2.5 top-2.5",
